...
#define GFX_MINSTREAMS  (4L) // minimum number of D3D streams in order to support HW T&L
...
#define GLF_EXT_VERTEXARRAYRANGE    (1UL<<23)   // GL_NV_vertex_array_range & GL_NV_fence
#define GLF_EXT_TBUFFER             (1UL<<24)   // 3DFX's T-Buffer (for Motion-blur effect)

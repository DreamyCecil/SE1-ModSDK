...
CEntityProperty CEnemySpawner_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x00000130<<8)+9, offsetof(CEnemySpawner, m_tmDelay), "Wait delay", 'W', 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x00000130<<8)+16, offsetof(CEnemySpawner, m_tmSingleWait), "Single delay", 'O', 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x00000130<<8)+5, offsetof(CEnemySpawner, m_tmGroupWait), "Group delay", 'G', 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x00000130<<8)+17, offsetof(CEnemySpawner, m_ctGroupSize), "Group size", 0, 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x00000130<<8)+8, offsetof(CEnemySpawner, m_ctTotal), "Total count", 'C', 0x7F0000FFUL, 0),

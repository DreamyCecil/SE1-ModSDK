...
#ifndef _EntitiesV_DoorController_INCLUDED
#define _EntitiesV_DoorController_INCLUDED 1
...
#define  STATE_CDoorController_DoorAuto 0x00dd0000
  BOOL DoorAuto(const CEntityEvent &__eeInput);
#define  STATE_CDoorController_DoorAutoActive 0x00dd0001
  BOOL DoorAutoActive(const CEntityEvent &__eeInput);
...
#define  STATE_CDoorController_DoorAutoInactive 0x00dd0008
  BOOL DoorAutoInactive(const CEntityEvent &__eeInput);
...
#define  STATE_CDoorController_DoorDummy 0x00dd000f
  BOOL DoorDummy(const CEntityEvent &__eeInput);
...
#define  STATE_CDoorController_DoorTriggered 0x00dd0012
  BOOL DoorTriggered(const CEntityEvent &__eeInput);
...
#define  STATE_CDoorController_DoorLocked 0x00dd0019
  BOOL DoorLocked(const CEntityEvent &__eeInput);
...
#define  STATE_CDoorController_DoorTriggeredAuto 0x00dd0020
  BOOL DoorTriggeredAuto(const CEntityEvent &__eeInput);

...
CEntityProperty CPlayerAnimator_properties[] = {
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000196<<8)+1, offsetof(CPlayerAnimator, m_penPlayer), "", 0, "m_penPlayer", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000196<<8)+5, offsetof(CPlayerAnimator, m_bReference), "", 0, "m_bReference", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+6, offsetof(CPlayerAnimator, m_fLastActionTime), "", 0, "m_fLastActionTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000196<<8)+7, offsetof(CPlayerAnimator, m_iContent), "", 0, "m_iContent", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000196<<8)+8, offsetof(CPlayerAnimator, m_bWaitJumpAnim), "", 0, "m_bWaitJumpAnim", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000196<<8)+9, offsetof(CPlayerAnimator, m_bCrouch), "", 0, "m_bCrouch", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000196<<8)+10, offsetof(CPlayerAnimator, m_iCrouchDownWait), "", 0, "m_iCrouchDownWait", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000196<<8)+11, offsetof(CPlayerAnimator, m_iRiseUpWait), "", 0, "m_iRiseUpWait", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000196<<8)+12, offsetof(CPlayerAnimator, m_bChangeWeapon), "", 0, "m_bChangeWeapon", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000196<<8)+13, offsetof(CPlayerAnimator, m_bSwim), "", 0, "m_bSwim", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000196<<8)+14, offsetof(CPlayerAnimator, m_iFlare), "", 0, "m_iFlare", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000196<<8)+15, offsetof(CPlayerAnimator, m_iSecondFlare), "", 0, "m_iSecondFlare", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000196<<8)+16, offsetof(CPlayerAnimator, m_bAttacking), "", 0, "m_bAttacking", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+19, offsetof(CPlayerAnimator, m_tmAttackingDue), "", 0, "m_tmAttackingDue", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+17, offsetof(CPlayerAnimator, m_tmFlareAdded), "", 0, "m_tmFlareAdded", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000196<<8)+18, offsetof(CPlayerAnimator, m_bDisableAnimating), "", 0, "m_bDisableAnimating", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000196<<8)+20, offsetof(CPlayerAnimator, m_vLastPlayerPosition), "", 0, "m_vLastPlayerPosition", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+21, offsetof(CPlayerAnimator, m_fEyesYLastOffset), "", 0, "m_fEyesYLastOffset", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+22, offsetof(CPlayerAnimator, m_fEyesYOffset), "", 0, "m_fEyesYOffset", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+23, offsetof(CPlayerAnimator, m_fEyesYSpeed), "", 0, "m_fEyesYSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+27, offsetof(CPlayerAnimator, m_fWeaponYLastOffset), "", 0, "m_fWeaponYLastOffset", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+28, offsetof(CPlayerAnimator, m_fWeaponYOffset), "", 0, "m_fWeaponYOffset", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+29, offsetof(CPlayerAnimator, m_fWeaponYSpeed), "", 0, "m_fWeaponYSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000196<<8)+30, offsetof(CPlayerAnimator, m_bMoving), "", 0, "m_bMoving", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+31, offsetof(CPlayerAnimator, m_fMoveLastBanking), "", 0, "m_fMoveLastBanking", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+32, offsetof(CPlayerAnimator, m_fMoveBanking), "", 0, "m_fMoveBanking", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000196<<8)+33, offsetof(CPlayerAnimator, m_iMovingSide), "", 0, "m_iMovingSide", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000196<<8)+34, offsetof(CPlayerAnimator, m_bSidestepBankingLeft), "", 0, "m_bSidestepBankingLeft", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000196<<8)+35, offsetof(CPlayerAnimator, m_bSidestepBankingRight), "", 0, "m_bSidestepBankingRight", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+36, offsetof(CPlayerAnimator, m_fSidestepLastBanking), "", 0, "m_fSidestepLastBanking", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+37, offsetof(CPlayerAnimator, m_fSidestepBanking), "", 0, "m_fSidestepBanking", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000196<<8)+38, offsetof(CPlayerAnimator, m_iWeaponLast), "", 0, "m_iWeaponLast", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000196<<8)+39, offsetof(CPlayerAnimator, m_fBodyAnimTime), "", 0, "m_fBodyAnimTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000196<<8)+255, offsetof(CPlayerAnimator, m_penPrediction), "", 0, "m_penPrediction", 0, 0),
};

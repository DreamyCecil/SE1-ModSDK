...
#ifndef _EntitiesV_PlayerWeaponsEffects_INCLUDED
#define _EntitiesV_PlayerWeaponsEffects_INCLUDED 1
...
#define  STATE_CPlayerWeaponsEffects_ShotgunShell 0x01950001
  BOOL ShotgunShell(const CEntityEvent &__eeInput);
...
#define  STATE_CPlayerWeaponsEffects_MachinegunShell 0x01950004
  BOOL MachinegunShell(const CEntityEvent &__eeInput);

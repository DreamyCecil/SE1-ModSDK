...
CEntityProperty CParticlesHolder_properties[] = {
 ...
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000000df<<8)+37, offsetof(CParticlesHolder, m_fMipFactorDisappear), "Disappear mip factor", 0, "m_fMipFactorDisappear", 0x7F0000FFUL, 0),
};

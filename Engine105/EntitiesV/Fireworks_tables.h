...
CEventHandlerEntry CFireworks_handlers[] = {
 {0x02680000, -1, CEntity::pEventHandler(&CFireworks::SpawnFireworks),DEBUGSTRING("CFireworks::SpawnFireworks")},
 ...
 {1, -1, CEntity::pEventHandler(&CFireworks::Main),DEBUGSTRING("CFireworks::Main")},

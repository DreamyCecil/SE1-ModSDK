...
CEntityProperty CAirElemental_properties[] = {
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x0000015b<<8)+2, offsetof(CAirElemental, m_bFloat), "", 0, "m_bFloat", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+3, offsetof(CAirElemental, m_fAttPosY), "", 0, "m_fAttPosY", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x0000015b<<8)+10, offsetof(CAirElemental, m_bInitialAnim), "", 0, "m_bInitialAnim", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x0000015b<<8)+20, offsetof(CAirElemental, m_penTrigger01), "AirBoss 90% Trigger", 0, "m_penTrigger01", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x0000015b<<8)+21, offsetof(CAirElemental, m_penTrigger02), "AirBoss 80% Trigger", 0, "m_penTrigger02", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x0000015b<<8)+22, offsetof(CAirElemental, m_penTrigger03), "AirBoss 70% Trigger", 0, "m_penTrigger03", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x0000015b<<8)+23, offsetof(CAirElemental, m_penTrigger04), "AirBoss 60% Trigger", 0, "m_penTrigger04", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x0000015b<<8)+24, offsetof(CAirElemental, m_penTrigger05), "AirBoss 50% Trigger", 0, "m_penTrigger05", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x0000015b<<8)+25, offsetof(CAirElemental, m_penTrigger06), "AirBoss 40% Trigger", 0, "m_penTrigger06", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x0000015b<<8)+26, offsetof(CAirElemental, m_penTrigger07), "AirBoss 30% Trigger", 0, "m_penTrigger07", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x0000015b<<8)+27, offsetof(CAirElemental, m_penTrigger08), "AirBoss 20% Trigger", 0, "m_penTrigger08", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x0000015b<<8)+28, offsetof(CAirElemental, m_penTrigger09), "AirBoss 10% Trigger", 0, "m_penTrigger09", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x0000015b<<8)+29, offsetof(CAirElemental, m_penTrigger10), "AirBoss 05% Trigger", 0, "m_penTrigger10", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+30, offsetof(CAirElemental, m_fAttSizeCurrent), "", 0, "m_fAttSizeCurrent", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+31, offsetof(CAirElemental, m_fAttSizeBegin), "", 0, "m_fAttSizeBegin", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+32, offsetof(CAirElemental, m_fAttSizeEnd), "", 0, "m_fAttSizeEnd", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+33, offsetof(CAirElemental, m_fAttSizeRequested), "", 0, "m_fAttSizeRequested", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x0000015b<<8)+34, offsetof(CAirElemental, m_bAttGrow), "", 0, "m_bAttGrow", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x0000015b<<8)+35, offsetof(CAirElemental, m_iSize), "", 0, "m_iSize", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+36, offsetof(CAirElemental, m_fLastSize), "", 0, "m_fLastSize", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+37, offsetof(CAirElemental, m_fTargetSize), "", 0, "m_fTargetSize", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+47, offsetof(CAirElemental, m_fGrowSpeed), "AirBoss Grow Speed", 0, "m_fGrowSpeed", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+43, offsetof(CAirElemental, m_tmWindNextFire), "", 0, "m_tmWindNextFire", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+44, offsetof(CAirElemental, m_fWindFireTimeMin), "AirBoss Wind Fire Min. Time", 0, "m_fWindFireTimeMin", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+45, offsetof(CAirElemental, m_fWindFireTimeMax), "AirBoss Wind Fire Max. Time", 0, "m_fWindFireTimeMax", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x0000015b<<8)+46, offsetof(CAirElemental, m_iWind), "", 0, "m_iWind", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x0000015b<<8)+50, offsetof(CAirElemental, m_bDying), "", 0, "m_bDying", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+51, offsetof(CAirElemental, m_tmDeath), "", 0, "m_tmDeath", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+52, offsetof(CAirElemental, m_fDeathDuration), "", 0, "m_fDeathDuration", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x0000015b<<8)+60, offsetof(CAirElemental, m_fWindBlastFirePosBegin), "", 0, "m_fWindBlastFirePosBegin", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x0000015b<<8)+61, offsetof(CAirElemental, m_fWindBlastFirePosEnd), "", 0, "m_fWindBlastFirePosEnd", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000015b<<8)+70, offsetof(CAirElemental, m_tmLastAnimation), "", 0, "m_tmLastAnimation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x0000015b<<8)+90, offsetof(CAirElemental, m_penDeathInflictor), "", 0, "m_penDeathInflictor", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x0000015b<<8)+91, offsetof(CAirElemental, m_bRenderParticles), "", 0, "m_bRenderParticles", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x0000015b<<8)+100, offsetof(CAirElemental, m_soFire), "", 0, "m_soFire", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x0000015b<<8)+101, offsetof(CAirElemental, m_soVoice), "", 0, "m_soVoice", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_COLOR, NULL, (0x0000015b<<8)+110, offsetof(CAirElemental, m_colParticles), "Color of particles", 0, "m_colParticles", 0x7F0000FFUL, 0),
};

...
static const char *CDevil_propnames[] = {
  "m_iAttID",
  "m_fDeltaWeaponPitch",
  "m_fDeltaWeaponHdg",
  "m_fFireTime",
  ...
  "m_dsLastDevilState",
  "m_dapAttackPower",
  "m_dapLastAttackPower",
  "m_bHasUpperWeapons",
  "m_vElectricitySource",
  "m_vElectricityTarget",
  "m_bRenderElectricity",
  "m_fAdjustWeaponTime",
  ...
  "m_tmDeathTime",
  "m_iLastCurrentAnim",
  "m_iLastScheduledAnim",
  "m_dsPreRegenerationDevilState",
  "m_soClimb",
  "m_soGrabLowerWeapons",
  "m_soGrabUpperWeapons",
  "m_soJumpIntoPyramid",
  "m_bForMPIntro",
};
#define CDevil_propnamesct ARRAYCOUNT(CDevil_propnames)

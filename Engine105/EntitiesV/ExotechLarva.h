...
static const char *CExotechLarva_propnames[] = {
  "m_penMarkerNew",
  "m_penMarkerOld",
  "m_fStopRadius",
  "m_fStretch",
  "m_fLarvaHealth",
  "m_fRechargePerSecond",
  "m_ltTarget",
  "m_penFirstRechargeTarget",
  "m_bRechargedAtLeastOnce",
  "m_vFirePosLeftPlasmaRel",
  "m_vFirePosRightPlasmaRel",
  "m_vFirePosTailRel",
  "m_vFirePosLeftLaserAbs",
  "m_vFirePosRightLaserAbs",
  "m_bLeftArmActive",
  "m_bRightArmActive",
  "m_iExplodingArm",
  "m_fMaxRechargedHealth",
  "m_bExploding",
  "m_bActive",
  "m_bRechargePose",
  "m_bLaserActive",
  ...
  "m_vRightLaserTarget",
  "m_bInvulnerable",
  "m_penLeftArmDestroyTarget",
  "m_penRightArmDestroyTarget",
  "m_penDeathTarget",
  "m_soFire1",
  "m_soFire2",
  "m_soFire3",
...
#define CExotechLarva_propnamesct ARRAYCOUNT(CExotechLarva_propnames)

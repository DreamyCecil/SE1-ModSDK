...
CEntityProperty CDestroyableArchitecture_properties[] = {
 ...
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000006b<<8)+15, offsetof(CDestroyableArchitecture, m_fDustStretch), "Dust stretch", 0, "m_fDustStretch", 0x7F0000FFUL, 0),
};

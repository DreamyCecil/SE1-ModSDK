 ...
 ************************************************************/
  ...
  void RenderDummyView(CDrawPort *pdp)
  {
    ...
    if (!GetSP()->sp_bSinglePlayer) {
      ...
      pdp->PutTextCXY( strMsg, pixDPWidth*0.5f, pixDPHeight*0.5f, SE_COL_BLUE_NEUTRAL_LT/*C_GREEN*/|CT_OPAQUE);
    }
  }
  ...
  void RenderPlayerView(CDrawPort *pdp, BOOL bShowExtras)
  {
    ...
    if (_pTimer->CurrentTick()<m_tmAnalyseEnd) {
      ...
      pdp->PutTextCXY( TRANS("Analyzing..."), pixDPWidth*0.5f, pixDPHeight*0.2f, SE_COL_BLUE_NEUTRAL_LT/*C_GREEN*/|ubA);
    }
  }

...
static struct AmmoInfo _aaiAmmo[8] = {
  ...
  { &_toAGrenades,      &_awiWeapons[9],  &_awiWeapons[10], 0, 0, 0, -9, FALSE }, //  3
  { &_toANapalm,        &_awiWeapons[12], NULL,             0, 0, 0, -9, FALSE }, //  4
  { &_toAElectricity,   &_awiWeapons[14], &_awiWeapons[15], 0, 0, 0, -9, FALSE }, //  5
  { &_toAIronBall,      &_awiWeapons[16], NULL,             0, 0, 0, -9, FALSE }, //  6
  { &_toAIronBall,      &_awiWeapons[17], NULL,             0, 0, 0, -9, FALSE }, //  7
};
...
extern void DrawHUD( const CPlayer *penPlayerCurrent, CDrawPort *pdpCurrent, BOOL bSnooping)
{
  ...
  _colHUD     = SE_COL_ORANGE_LIGHT; //C_GREEN;

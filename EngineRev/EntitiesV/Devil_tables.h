...
CEntityProperty CDevil_properties[] = {
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x14c<<8)+1, 0x5C0, "", 0, "m_iAttID", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+2, 0x5C4, "", 0, "m_fDeltaWeaponPitch", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+3, 0x5C8, "", 0, "m_fDeltaWeaponHdg", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+4, 0x5CC, "", 0, "m_fFireTime", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_ANIMOBJECT, NULL, (0x14c<<8)+5, 0x5D0, "", 0, "m_aoLightAnimation", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_ENTITYPTR, NULL, (0x14c<<8)+6, 0x5F0, "Action", 'O', "m_penAction", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x14c<<8)+8, 0x5F4, "", 0, "m_iFiredProjectiles", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x14c<<8)+9, 0x5F8, "", 0, "m_iToFireProjectiles", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+10, 0x5FC, "", 0, "m_fPauseStretcher", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+11, 0x600, "", 0, "m_tmLastPause", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_ENUM, &DevilState_enum, (0x14c<<8)+12, 0x604, "", 0, "m_dsDevilState", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+13, 0x608, "", 0, "m_tmLastAngry", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_PLACEMENT3D, NULL, (0x14c<<8)+14, 0x60C, "", 0, "m_plTeleport", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+16, 0x624, "", 0, "m_tmTemp", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_ENUM, &DevilState_enum, (0x14c<<8)+17, 0x628, "", 0, "m_dsLastDevilState", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_ENUM, &DevilAttackPower_enum, (0x14c<<8)+18, 0x62C, "", 0, "m_dapAttackPower", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_ENUM, &DevilAttackPower_enum, (0x14c<<8)+19, 0x630, "", 0, "m_dapLastAttackPower", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x14c<<8)+20, 0x634, "", 0, "m_bHasUpperWeapons", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT3D, NULL, (0x14c<<8)+21, 0x638, "", 0, "m_vElectricitySource", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT3D, NULL, (0x14c<<8)+22, 0x644, "", 0, "m_vElectricityTarget", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x14c<<8)+23, 0x650, "", 0, "m_bRenderElectricity", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+24, 0x654, "", 0, "m_fAdjustWeaponTime", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x14c<<8)+25, 0x658, "", 0, "m_bWasOnceInMainLoop", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+26, 0x65C, "", 0, "m_tmHitBySpaceShipBeam", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x14c<<8)+27, 0x660, "", 0, "m_soLeft", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x14c<<8)+28, 0x6DC, "", 0, "m_soRight", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+29, 0x758, "", 0, "m_fLastWalkTime", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+30, 0x75C, "", 0, "m_tmFireBreathStart", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+31, 0x760, "", 0, "m_tmFireBreathStop", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT3D, NULL, (0x14c<<8)+32, 0x764, "", 0, "m_vFireBreathSource", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT3D, NULL, (0x14c<<8)+33, 0x770, "", 0, "m_vFireBreathTarget", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+34, 0x77C, "", 0, "m_tmRegenerationStart", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+35, 0x780, "", 0, "m_tmRegenerationStop", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+36, 0x784, "", 0, "m_tmNextFXTime", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x14c<<8)+37, 0x788, "", 0, "m_iNextChannel", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x14c<<8)+38, 0x78C, "", 0, "m_soWeapon0", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x14c<<8)+39, 0x808, "", 0, "m_soWeapon1", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x14c<<8)+40, 0x884, "", 0, "m_soWeapon2", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x14c<<8)+41, 0x900, "", 0, "m_soWeapon3", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x14c<<8)+42, 0x97C, "", 0, "m_soWeapon4", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x14c<<8)+43, 0x9F8, "", 0, "m_iAngryAnim", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x14c<<8)+44, 0x9FC, "", 0, "m_iAngrySound", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x14c<<8)+45, 0xA00, "", 0, "m_tmDeathTime", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x14c<<8)+50, 0xA04, "", 0, "m_iLastCurrentAnim", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x14c<<8)+51, 0xA08, "", 0, "m_iLastScheduledAnim", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_ENUM, &DevilState_enum, (0x14c<<8)+52, 0xA0C, "", 0, "m_dsPreRegenerationDevilState", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x14c<<8)+60, 0xA10, "", 0, "m_soClimb", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x14c<<8)+61, 0xA8C, "", 0, "m_soGrabLowerWeapons", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x14c<<8)+62, 0xB08, "", 0, "m_soGrabUpperWeapons", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x14c<<8)+63, 0xB84, "", 0, "m_soJumpIntoPyramid", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x14c<<8)+70, 0xC00, "MP Intro", 0, "m_bForMPIntro", 0x7F0000FFUL, 0),
};
...
ENTITY_CLASSDEFINITION(CDevil, CEnemyBase, "Devil", "Thumbnails\\Devil.tbn", 332);

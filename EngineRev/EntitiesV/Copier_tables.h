...
CEntityProperty CCopier_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_STRING, NULL, (0xe1<<8)+3, 0x114, "", 0, "m_strDescription", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_ENTITYPTR, NULL, (0xe1<<8)+2, 0x118, "Target", 'T', "m_penTarget", 0x8C2717FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0xe1<<8)+4, 0x11C, "Spawn Effect", 'X', "m_bSpawnEffect", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0xe1<<8)+5, 0x120, "Telefrag", 'F', "m_bTelefrag", 0x7F0000FFUL, 0),
};
...
ENTITY_CLASSDEFINITION(CCopier, CRationalEntity, "Copier", "Thumbnails\\Copier.tbn", 225);

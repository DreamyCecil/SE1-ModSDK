...
EP_ENUMBEG(WeaponItemType)
  ...
  EP_ENUMVALUE(WIT_GHOSTBUSTER, "Ghost Buster"),
  EP_ENUMVALUE(WIT_PLASMATHROWER, "Plasma Thrower"),
  EP_ENUMVALUE(WIT_MINELAYER, "Mine Layer"),
EP_ENUMEND(WeaponItemType);

#define ENTITYCLASS CWeaponItem

CEntityProperty CWeaponItem_properties[] = {
 CEntityProperty(CEntityProperty::EPT_ENUM, &WeaponItemType_enum, (0x322<<8)+1, 0x418, "Type", 'Y', "m_EwitType", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x322<<8)+2, 0x41C, "Ammo amount", 0, "m_iAmmoAmount", 0x7F0000FFUL, 0),
};
...
#define CWeaponItem_MODEL_220 0x322DC // (0x322<<8)+220
 CEntityComponent(ECT_MODEL, CWeaponItem_MODEL_220, "EFNM" "Models\\Weapons\\Ghostbuster\\GhostBusterItem.mdl"),
#define CWeaponItem_MODEL_221 0x322DD // (0x322<<8)+221
 CEntityComponent(ECT_MODEL, CWeaponItem_MODEL_221, "EFNM" "Models\\Weapons\\Ghostbuster\\Body.mdl"),
#define CWeaponItem_TEXTURE_222 0x322DE // (0x322<<8)+222
 CEntityComponent(ECT_TEXTURE, CWeaponItem_TEXTURE_222, "EFNM" "Models\\Weapons\\Ghostbuster\\Body.tex"),
#define CWeaponItem_MODEL_223 0x322DF // (0x322<<8)+223
 CEntityComponent(ECT_MODEL, CWeaponItem_MODEL_223, "EFNM" "Models\\Weapons\\Ghostbuster\\Rotator.mdl"),
#define CWeaponItem_TEXTURE_224 0x322E0 // (0x322<<8)+224
 CEntityComponent(ECT_TEXTURE, CWeaponItem_TEXTURE_224, "EFNM" "Models\\Weapons\\Ghostbuster\\Rotator.tex"),
#define CWeaponItem_MODEL_230 0x322E6 // (0x322<<8)+230
 CEntityComponent(ECT_MODEL, CWeaponItem_MODEL_230, "EFNM" "Models\\Weapons\\PlasmaThrower\\LaserItem.mdl"),
#define CWeaponItem_MODEL_231 0x322E7 // (0x322<<8)+231
 CEntityComponent(ECT_MODEL, CWeaponItem_MODEL_231, "EFNM" "Models\\Weapons\\PlasmaThrower\\Body.mdl"),
#define CWeaponItem_MODEL_232 0x322E8 // (0x322<<8)+232
 CEntityComponent(ECT_MODEL, CWeaponItem_MODEL_232, "EFNM" "Models\\Weapons\\PlasmaThrower\\barrel.mdl"),
#define CWeaponItem_TEXTURE_233 0x322E9 // (0x322<<8)+233
 CEntityComponent(ECT_TEXTURE, CWeaponItem_TEXTURE_233, "EFNM" "Models\\Weapons\\PlasmaThrower\\Body.tex"),
#define CWeaponItem_TEXTURE_234 0x322EA // (0x322<<8)+234
 CEntityComponent(ECT_TEXTURE, CWeaponItem_TEXTURE_234, "EFNM" "Models\\Weapons\\PlasmaThrower\\barrel.tex"),
#define CWeaponItem_MODEL_235 0x322EB // (0x322<<8)+235
 CEntityComponent(ECT_MODEL, CWeaponItem_MODEL_235, "EFNM" "Models\\Weapons\\PlasmaThrower\\barrel_big.mdl"),
#define CWeaponItem_TEXTURE_236 0x322EC // (0x322<<8)+236
 CEntityComponent(ECT_TEXTURE, CWeaponItem_TEXTURE_236, "EFNM" "Models\\Weapons\\PlasmaThrower\\barrel_big.tex"),
#define CWeaponItem_MODEL_240 0x322F0 // (0x322<<8)+240
 CEntityComponent(ECT_MODEL, CWeaponItem_MODEL_240, "EFNM" "Models\\Weapons\\MineLayer\\MovingPipe.mdl"),
#define CWeaponItem_TEXTURE_241 0x322F1 // (0x322<<8)+241
 CEntityComponent(ECT_TEXTURE, CWeaponItem_TEXTURE_241, "EFNM" "Models\\Weapons\\MineLayer\\Body.tex"),
#define CWeaponItem_TEXTURE_242 0x322F2 // (0x322<<8)+242
 CEntityComponent(ECT_TEXTURE, CWeaponItem_TEXTURE_242, "EFNM" "Models\\Weapons\\MineLayer\\MovingPipe.tex"),
#define CWeaponItem_MODEL_243 0x322F3 // (0x322<<8)+243
 CEntityComponent(ECT_MODEL, CWeaponItem_MODEL_243, "EFNM" "Models\\Weapons\\GrenadeLauncher\\GrenadeLauncherItem.mdl"),
#define CWeaponItem_MODEL_244 0x322F4 // (0x322<<8)+244
 CEntityComponent(ECT_MODEL, CWeaponItem_MODEL_244, "EFNM" "Models\\Weapons\\MineLayer\\Body.mdl"),
};
#define CWeaponItem_componentsct ARRAYCOUNT(CWeaponItem_components)

CEventHandlerEntry CWeaponItem_handlers[] = {
 {0x03220001, STATE_CItem_ItemCollected, CEntity::pEventHandler(&CWeaponItem::ItemCollected),DEBUGSTRING("CWeaponItem::ItemCollected")},
 {1, -1, CEntity::pEventHandler(&CWeaponItem::Main),DEBUGSTRING("CWeaponItem::Main")},
...
ENTITY_CLASSDEFINITION(CWeaponItem, CItem, "Weapon Item", "Thumbnails\\WeaponItem.tbn", 802);

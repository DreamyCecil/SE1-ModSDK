...
CEntityProperty CShooter_properties[] = {
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x159<<8)+2, 0x358, "Shooting Period", 0, "m_fShootingPeriod", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_ENUM, &CShooter_Enum0_enum, (0x159<<8)+5, 0x35C, "Type", 'Y', "m_sftType", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x159<<8)+7, 0x360, "Health", 0, "m_fHealth", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x159<<8)+8, 0x364, "Cannon/fire ball size", 0, "m_fCannonBallSize", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x159<<8)+9, 0x368, "Cannon/fire ball power", 0, "m_fCannonBallPower", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_ANIMATION, NULL, (0x159<<8)+10, 0x36C, "Model pre-fire animation", 0, "m_iModelPreFireAnimation", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_ANIMATION, NULL, (0x159<<8)+11, 0x370, "Texture pre-fire animation", 0, "m_iTexturePreFireAnimation", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_ANIMATION, NULL, (0x159<<8)+12, 0x374, "Model post-fire animation", 0, "m_iModelPostFireAnimation", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_ANIMATION, NULL, (0x159<<8)+13, 0x378, "Texture post-fire animation", 0, "m_iTexturePostFireAnimation", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x159<<8)+14, 0x37C, "Flame burst duration", 0, "m_fFlameBurstDuration", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x159<<8)+15, 0x380, "Random begin wait time", 0, "m_fRndBeginWait", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_ENTITYPTR, NULL, (0x159<<8)+20, 0x384, "Sound launch", 0, "m_penSoundLaunch", 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x159<<8)+21, 0x388, "", 0, "m_soLaunch", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_ENTITYPTR, NULL, (0x159<<8)+30, 0x404, "", 0, "m_penFlame", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x159<<8)+50, 0x408, "", 0, "m_bFiring", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x159<<8)+51, 0x40C, "", 0, "m_bIndestructable", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x159<<8)+60, 0x410, "", 0, "m_tmFlameStart", 0x0UL, 0),
};
...
ENTITY_CLASSDEFINITION(CShooter, CModelHolder2, "Shooter", "Thumbnails\\Shooter.tbn", 345);

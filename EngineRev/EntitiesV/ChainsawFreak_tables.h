...
CEntityProperty CChainsawFreak_properties[] = {
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x156<<8)+1, 0x5E8, "", 0, "m_bRunAttack", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x156<<8)+2, 0x5EC, "", 0, "m_bSawHit", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_ENTITYPTR, NULL, (0x156<<8)+3, 0x5F0, "", 0, "m_penLastTouched", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x156<<8)+4, 0x5F4, "", 0, "m_soFeet", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x156<<8)+5, 0x670, "", 0, "m_bRunSoundPlaying", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_INDEX, NULL, (0x156<<8)+6, 0x674, "", 0, "m_iRunType", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x156<<8)+10, 0x678, "", 0, "m_bAttacking", 0x0UL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x156<<8)+11, 0x67C, "", 0, "m_fSightSoundBegin", 0x0UL, 0),
};
...
CEventHandlerEntry CChainsawFreak_handlers[] = {
 {0x01560000, STATE_CEnemyBase_Hit, CEntity::pEventHandler(&CChainsawFreak::Hit),DEBUGSTRING("CChainsawFreak::Hit")},
 ...
 {0x0156000a, STATE_CEnemyBase_AttackEnemy, CEntity::pEventHandler(&CChainsawFreak::AttackEnemy),DEBUGSTRING("CChainsawFreak::AttackEnemy")},
 {0x0156000b, STATE_CEnemyBase_BeIdle, CEntity::pEventHandler(&CChainsawFreak::BeIdle),DEBUGSTRING("CChainsawFreak::BeIdle")},
 {0x0156000c, STATE_CEnemyRunInto_PostRunAwayFromEnemy, CEntity::pEventHandler(&CChainsawFreak::PostRunAwayFromEnemy),DEBUGSTRING("CChainsawFreak::PostRunAwayFromEnemy")},
 ...
 {1, -1, CEntity::pEventHandler(&CChainsawFreak::Main),DEBUGSTRING("CChainsawFreak::Main")},
};
...
ENTITY_CLASSDEFINITION(CChainsawFreak, CEnemyRunInto, "ChainsawFreak", "Thumbnails\\ChainsawFreak.tbn", 342);

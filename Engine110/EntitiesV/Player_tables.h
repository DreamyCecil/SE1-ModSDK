...
CEntityProperty CPlayer_properties[] = {
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_STRING, NULL, (0x00000191<<8)+1, offsetof(CPlayer, m_strName), "Name", 0, "m_strName", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_COLOR, NULL, (0x00000191<<8)+2, offsetof(CPlayer, m_ulLastButtons), "", 0, "m_ulLastButtons", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+3, offsetof(CPlayer, m_fArmor), "", 0, "m_fArmor", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_STRING, NULL, (0x00000191<<8)+4, offsetof(CPlayer, m_strGroup), "", 0, "m_strGroup", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+5, offsetof(CPlayer, m_ulKeys), "", 0, "m_ulKeys", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+6, offsetof(CPlayer, m_fMaxHealth), "", 0, "m_fMaxHealth", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+7, offsetof(CPlayer, m_ulFlags), "", 0, "m_ulFlags", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000191<<8)+16, offsetof(CPlayer, m_penWeapons), "", 0, "m_penWeapons", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000191<<8)+17, offsetof(CPlayer, m_penAnimator), "", 0, "m_penAnimator", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000191<<8)+18, offsetof(CPlayer, m_penView), "", 0, "m_penView", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000191<<8)+19, offsetof(CPlayer, m_pen3rdPersonView), "", 0, "m_pen3rdPersonView", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+20, offsetof(CPlayer, m_iViewState), "", 0, "m_iViewState", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+21, offsetof(CPlayer, m_iLastViewState), "", 0, "m_iLastViewState", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANIMOBJECT, NULL, (0x00000191<<8)+26, offsetof(CPlayer, m_aoLightAnimation), "", 0, "m_aoLightAnimation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+27, offsetof(CPlayer, m_fDamageAmmount), "", 0, "m_fDamageAmmount", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+28, offsetof(CPlayer, m_tmWoundedTime), "", 0, "m_tmWoundedTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+29, offsetof(CPlayer, m_tmScreamTime), "", 0, "m_tmScreamTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+33, offsetof(CPlayer, m_iGender), "", 0, "m_iGender", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENUM, &PlayerState_enum, (0x00000191<<8)+34, offsetof(CPlayer, m_pstState), "", 0, "m_pstState", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+35, offsetof(CPlayer, m_fFallTime), "", 0, "m_fFallTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+36, offsetof(CPlayer, m_fSwimTime), "", 0, "m_fSwimTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+45, offsetof(CPlayer, m_tmOutOfWater), "", 0, "m_tmOutOfWater", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+37, offsetof(CPlayer, m_tmMoveSound), "", 0, "m_tmMoveSound", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000191<<8)+38, offsetof(CPlayer, m_bMoveSoundLeft), "", 0, "m_bMoveSoundLeft", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+39, offsetof(CPlayer, m_tmNextAmbientOnce), "", 0, "m_tmNextAmbientOnce", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+43, offsetof(CPlayer, m_tmMouthSoundLast), "", 0, "m_tmMouthSoundLast", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000191<<8)+40, offsetof(CPlayer, m_penCamera), "", 0, "m_penCamera", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_STRING, NULL, (0x00000191<<8)+41, offsetof(CPlayer, m_strCenterMessage), "", 0, "m_strCenterMessage", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+42, offsetof(CPlayer, m_tmCenterMessageEnd), "", 0, "m_tmCenterMessageEnd", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000191<<8)+48, offsetof(CPlayer, m_bPendingMessage), "", 0, "m_bPendingMessage", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+47, offsetof(CPlayer, m_tmMessagePlay), "", 0, "m_tmMessagePlay", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+49, offsetof(CPlayer, m_tmAnalyseEnd), "", 0, "m_tmAnalyseEnd", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000191<<8)+50, offsetof(CPlayer, m_bComputerInvoked), "", 0, "m_bComputerInvoked", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+57, offsetof(CPlayer, m_tmAnimateInbox), "", 0, "m_tmAnimateInbox", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000191<<8)+44, offsetof(CPlayer, m_penMainMusicHolder), "", 0, "m_penMainMusicHolder", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+51, offsetof(CPlayer, m_tmLastDamage), "", 0, "m_tmLastDamage", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+52, offsetof(CPlayer, m_fMaxDamageAmmount), "", 0, "m_fMaxDamageAmmount", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000191<<8)+53, offsetof(CPlayer, m_vDamage), "", 0, "m_vDamage", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+54, offsetof(CPlayer, m_tmSpraySpawned), "", 0, "m_tmSpraySpawned", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+55, offsetof(CPlayer, m_fSprayDamage), "", 0, "m_fSprayDamage", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000191<<8)+56, offsetof(CPlayer, m_penSpray), "", 0, "m_penSpray", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+60, offsetof(CPlayer, m_soWeapon0), "", 0, "m_soWeapon0", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+61, offsetof(CPlayer, m_soWeapon1), "", 0, "m_soWeapon1", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+62, offsetof(CPlayer, m_soWeapon2), "", 0, "m_soWeapon2", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+63, offsetof(CPlayer, m_soWeapon3), "", 0, "m_soWeapon3", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+64, offsetof(CPlayer, m_soWeaponAmbient), "", 0, "m_soWeaponAmbient", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+65, offsetof(CPlayer, m_soPowerUpBeep), "", 0, "m_soPowerUpBeep", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+70, offsetof(CPlayer, m_soMouth), "", 0, "m_soMouth", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+71, offsetof(CPlayer, m_soFootL), "", 0, "m_soFootL", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+72, offsetof(CPlayer, m_soFootR), "", 0, "m_soFootR", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+73, offsetof(CPlayer, m_soBody), "", 0, "m_soBody", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+74, offsetof(CPlayer, m_soLocalAmbientLoop), "", 0, "m_soLocalAmbientLoop", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+75, offsetof(CPlayer, m_soLocalAmbientOnce), "", 0, "m_soLocalAmbientOnce", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+76, offsetof(CPlayer, m_soMessage), "", 0, "m_soMessage", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+77, offsetof(CPlayer, m_soHighScore), "", 0, "m_soHighScore", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+78, offsetof(CPlayer, m_soSpeech), "", 0, "m_soSpeech", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000191<<8)+79, offsetof(CPlayer, m_soSniperZoom), "", 0, "m_soSniperZoom", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+81, offsetof(CPlayer, m_iMana), "", 0, "m_iMana", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+94, offsetof(CPlayer, m_fManaFraction), "", 0, "m_fManaFraction", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+84, offsetof(CPlayer, m_iHighScore), "", 0, "m_iHighScore", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+85, offsetof(CPlayer, m_iBeatenHighScore), "", 0, "m_iBeatenHighScore", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+89, offsetof(CPlayer, m_tmLatency), "", 0, "m_tmLatency", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+88, offsetof(CPlayer, m_tmLatencyLastAvg), "", 0, "m_tmLatencyLastAvg", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+87, offsetof(CPlayer, m_tmLatencyAvgSum), "", 0, "m_tmLatencyAvgSum", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+86, offsetof(CPlayer, m_ctLatencyAvg), "", 0, "m_ctLatencyAvg", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000191<<8)+96, offsetof(CPlayer, m_bEndOfLevel), "", 0, "m_bEndOfLevel", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000191<<8)+97, offsetof(CPlayer, m_bEndOfGame), "", 0, "m_bEndOfGame", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+98, offsetof(CPlayer, m_iMayRespawn), "", 0, "m_iMayRespawn", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+99, offsetof(CPlayer, m_tmSpawned), "", 0, "m_tmSpawned", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000191<<8)+100, offsetof(CPlayer, m_vDied), "", 0, "m_vDied", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000191<<8)+101, offsetof(CPlayer, m_aDied), "", 0, "m_aDied", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+103, offsetof(CPlayer, m_tmEstTime), "", 0, "m_tmEstTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+105, offsetof(CPlayer, m_iTimeScore), "", 0, "m_iTimeScore", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+106, offsetof(CPlayer, m_iStartTime), "", 0, "m_iStartTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+107, offsetof(CPlayer, m_iEndTime), "", 0, "m_iEndTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+108, offsetof(CPlayer, m_tmLevelStarted), "", 0, "m_tmLevelStarted", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_STRING, NULL, (0x00000191<<8)+93, offsetof(CPlayer, m_strLevelStats), "", 0, "m_strLevelStats", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000191<<8)+110, offsetof(CPlayer, m_penActionMarker), "", 0, "m_penActionMarker", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+111, offsetof(CPlayer, m_fAutoSpeed), "", 0, "m_fAutoSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+112, offsetof(CPlayer, m_iAutoOrgWeapon), "", 0, "m_iAutoOrgWeapon", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000191<<8)+113, offsetof(CPlayer, m_vAutoSpeed), "", 0, "m_vAutoSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+114, offsetof(CPlayer, m_tmSpiritStart), "", 0, "m_tmSpiritStart", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+115, offsetof(CPlayer, m_tmFadeStart), "", 0, "m_tmFadeStart", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+120, offsetof(CPlayer, m_tmLastPicked), "", 0, "m_tmLastPicked", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_STRING, NULL, (0x00000191<<8)+121, offsetof(CPlayer, m_strPickedName), "", 0, "m_strPickedName", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+122, offsetof(CPlayer, m_fPickedAmmount), "", 0, "m_fPickedAmmount", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+123, offsetof(CPlayer, m_fPickedMana), "", 0, "m_fPickedMana", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+130, offsetof(CPlayer, m_iLastHealth), "", 0, "m_iLastHealth", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+131, offsetof(CPlayer, m_iLastArmor), "", 0, "m_iLastArmor", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+132, offsetof(CPlayer, m_iLastAmmo), "", 0, "m_iLastAmmo", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+135, offsetof(CPlayer, m_tmHealthChanged), "", 0, "m_tmHealthChanged", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+136, offsetof(CPlayer, m_tmArmorChanged), "", 0, "m_tmArmorChanged", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+137, offsetof(CPlayer, m_tmAmmoChanged), "", 0, "m_tmAmmoChanged", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+138, offsetof(CPlayer, m_tmMinigunAutoFireStart), "", 0, "m_tmMinigunAutoFireStart", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000191<<8)+150, offsetof(CPlayer, m_vLastStain), "", 0, "m_vLastStain", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANGLE3D, NULL, (0x00000191<<8)+151, offsetof(CPlayer, m_aLastRotation), "", 0, "m_aLastRotation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANGLE3D, NULL, (0x00000191<<8)+152, offsetof(CPlayer, m_aLastViewRotation), "", 0, "m_aLastViewRotation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000191<<8)+153, offsetof(CPlayer, m_vLastTranslation), "", 0, "m_vLastTranslation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANGLE3D, NULL, (0x00000191<<8)+154, offsetof(CPlayer, m_aLocalRotation), "", 0, "m_aLocalRotation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANGLE3D, NULL, (0x00000191<<8)+155, offsetof(CPlayer, m_aLocalViewRotation), "", 0, "m_aLocalViewRotation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000191<<8)+156, offsetof(CPlayer, m_vLocalTranslation), "", 0, "m_vLocalTranslation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+160, offsetof(CPlayer, m_tmInvisibility), "", 0, "m_tmInvisibility", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+161, offsetof(CPlayer, m_tmInvulnerability), "", 0, "m_tmInvulnerability", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+162, offsetof(CPlayer, m_tmSeriousDamage), "", 0, "m_tmSeriousDamage", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+163, offsetof(CPlayer, m_tmSeriousSpeed), "", 0, "m_tmSeriousSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+166, offsetof(CPlayer, m_tmInvisibilityMax), "", 0, "m_tmInvisibilityMax", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+167, offsetof(CPlayer, m_tmInvulnerabilityMax), "", 0, "m_tmInvulnerabilityMax", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+168, offsetof(CPlayer, m_tmSeriousDamageMax), "", 0, "m_tmSeriousDamageMax", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+169, offsetof(CPlayer, m_tmSeriousSpeedMax), "", 0, "m_tmSeriousSpeedMax", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+180, offsetof(CPlayer, m_tmChainShakeEnd), "", 0, "m_tmChainShakeEnd", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+181, offsetof(CPlayer, m_fChainShakeStrength), "", 0, "m_fChainShakeStrength", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+182, offsetof(CPlayer, m_fChainShakeFreqMod), "", 0, "m_fChainShakeFreqMod", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+183, offsetof(CPlayer, m_fChainsawShakeDX), "", 0, "m_fChainsawShakeDX", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+184, offsetof(CPlayer, m_fChainsawShakeDY), "", 0, "m_fChainsawShakeDY", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+190, offsetof(CPlayer, m_iSeriousBombCount), "", 0, "m_iSeriousBombCount", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000191<<8)+191, offsetof(CPlayer, m_iLastSeriousBombCount), "", 0, "m_iLastSeriousBombCount", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000191<<8)+192, offsetof(CPlayer, m_tmSeriousBombFired), "", 0, "m_tmSeriousBombFired", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000191<<8)+255, offsetof(CPlayer, m_penPrediction), "", 0, "m_penPrediction", 0, 0),
};
...
CEventHandlerEntry CPlayer_handlers[] = {
 {0x01910005, -1, CEntity::pEventHandler(&CPlayer::Wounded),DEBUGSTRING("CPlayer::Wounded")},
 {0x01910006, -1, CEntity::pEventHandler(&CPlayer::WorldChange),DEBUGSTRING("CPlayer::WorldChange")},
 {0x01910007, -1, CEntity::pEventHandler(&CPlayer::WorldChangeDead),DEBUGSTRING("CPlayer::WorldChangeDead")},
 ...
 {0x0191000a, -1, CEntity::pEventHandler(&CPlayer::Death),DEBUGSTRING("CPlayer::Death")},

...
CEntityProperty CAmmoPack_properties[] = {
 ...
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000326<<8)+14, offsetof(CAmmoPack, m_iNapalm), "Napalm", 'P', "m_iNapalm", 0x7F0000FFUL, 0),
 ...
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000326<<8)+17, offsetof(CAmmoPack, m_iSniperBullets), "Sniper bullets", 'N', "m_iSniperBullets", 0x7F0000FFUL, 0),
};

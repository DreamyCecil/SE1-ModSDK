...
CEntityProperty CDamager_properties[] = {
 ...
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x000000e5<<8)+10, offsetof(CDamager, m_penLastDamaged), "", 0, "m_penLastDamaged", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000000e5<<8)+11, offsetof(CDamager, m_tmLastDamage), "", 0, "m_tmLastDamage", 0, 0),
};

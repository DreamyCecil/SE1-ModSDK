...
CEntityProperty CProjectile_properties[] = {
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x000001f5<<8)+1, offsetof(CProjectile, m_penLauncher), "", 0, "m_penLauncher", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENUM, &ProjectileType_enum, (0x000001f5<<8)+2, offsetof(CProjectile, m_prtType), "", 0, "m_prtType", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENUM, &ProjectileMovingType_enum, (0x000001f5<<8)+3, offsetof(CProjectile, m_pmtMove), "", 0, "m_pmtMove", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x000001f5<<8)+4, offsetof(CProjectile, m_penParticles), "", 0, "m_penParticles", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x000001f5<<8)+5, offsetof(CProjectile, m_penTarget), "", 0, "m_penTarget", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x000001f5<<8)+6, offsetof(CProjectile, m_penLastDamaged), "", 0, "m_penLastDamaged", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+10, offsetof(CProjectile, m_fSpeed), "", 0, "m_fSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+11, offsetof(CProjectile, m_fIgnoreTime), "", 0, "m_fIgnoreTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+12, offsetof(CProjectile, m_fFlyTime), "", 0, "m_fFlyTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+13, offsetof(CProjectile, m_fStartTime), "", 0, "m_fStartTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+14, offsetof(CProjectile, m_fDamageAmount), "", 0, "m_fDamageAmount", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+15, offsetof(CProjectile, m_fRangeDamageAmount), "", 0, "m_fRangeDamageAmount", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+16, offsetof(CProjectile, m_fDamageHotSpotRange), "", 0, "m_fDamageHotSpotRange", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+17, offsetof(CProjectile, m_fDamageFallOffRange), "", 0, "m_fDamageFallOffRange", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+18, offsetof(CProjectile, m_fSoundRange), "", 0, "m_fSoundRange", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x000001f5<<8)+19, offsetof(CProjectile, m_bExplode), "", 0, "m_bExplode", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x000001f5<<8)+20, offsetof(CProjectile, m_bLightSource), "", 0, "m_bLightSource", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x000001f5<<8)+21, offsetof(CProjectile, m_bCanHitHimself), "", 0, "m_bCanHitHimself", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x000001f5<<8)+22, offsetof(CProjectile, m_bCanBeDestroyed), "", 0, "m_bCanBeDestroyed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+23, offsetof(CProjectile, m_fWaitAfterDeath), "", 0, "m_fWaitAfterDeath", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+24, offsetof(CProjectile, m_aRotateSpeed), "", 0, "m_aRotateSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+25, offsetof(CProjectile, m_tmExpandBox), "", 0, "m_tmExpandBox", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+26, offsetof(CProjectile, m_tmInvisibility), "", 0, "m_tmInvisibility", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x000001f5<<8)+27, offsetof(CProjectile, m_iRebounds), "", 0, "m_iRebounds", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+28, offsetof(CProjectile, m_fStretch), "", 0, "m_fStretch", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x000001f5<<8)+30, offsetof(CProjectile, m_soEffect), "", 0, "m_soEffect", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x000001f5<<8)+31, offsetof(CProjectile, m_soExplosion), "", 0, "m_soExplosion", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001f5<<8)+35, offsetof(CProjectile, m_fGuidedMaxSpeedFactor), "", 0, "m_fGuidedMaxSpeedFactor", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x000001f5<<8)+50, offsetof(CProjectile, bLockedOn), "", 0, "bLockedOn", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x000001f5<<8)+51, offsetof(CProjectile, m_bLeftFlame), "", 0, "m_bLeftFlame", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x000001f5<<8)+255, offsetof(CProjectile, m_penPrediction), "", 0, "m_penPrediction", 0, 0),
};

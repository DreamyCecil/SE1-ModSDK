...
CEntityProperty CEnemyFly_properties[] = {
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENUM, &EnemyFlyType_enum, (0x00000137<<8)+1, offsetof(CEnemyFly, m_EeftType), "Type", 'T', "m_EeftType", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000137<<8)+2, offsetof(CEnemyFly, m_bInAir), "", 0, "m_bInAir", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000137<<8)+3, offsetof(CEnemyFly, m_bAirAttack), "", 0, "m_bAirAttack", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000137<<8)+4, offsetof(CEnemyFly, m_bStartInAir), "", 0, "m_bStartInAir", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+16, offsetof(CEnemyFly, m_fGroundToAirSpeed), "", 0, "m_fGroundToAirSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+17, offsetof(CEnemyFly, m_fAirToGroundSpeed), "", 0, "m_fAirToGroundSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+18, offsetof(CEnemyFly, m_fAirToGroundMin), "", 0, "m_fAirToGroundMin", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+19, offsetof(CEnemyFly, m_fAirToGroundMax), "", 0, "m_fAirToGroundMax", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+27, offsetof(CEnemyFly, m_fFlyHeight), "", 0, "m_fFlyHeight", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+10, offsetof(CEnemyFly, m_fFlyWalkSpeed), "", 0, "m_fFlyWalkSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANGLE, NULL, (0x00000137<<8)+11, offsetof(CEnemyFly, m_aFlyWalkRotateSpeed), "", 0, "m_aFlyWalkRotateSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+12, offsetof(CEnemyFly, m_fFlyAttackRunSpeed), "", 0, "m_fFlyAttackRunSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANGLE, NULL, (0x00000137<<8)+13, offsetof(CEnemyFly, m_aFlyAttackRotateSpeed), "", 0, "m_aFlyAttackRotateSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+14, offsetof(CEnemyFly, m_fFlyCloseRunSpeed), "", 0, "m_fFlyCloseRunSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANGLE, NULL, (0x00000137<<8)+15, offsetof(CEnemyFly, m_aFlyCloseRotateSpeed), "", 0, "m_aFlyCloseRotateSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+20, offsetof(CEnemyFly, m_fFlyAttackDistance), "", 0, "m_fFlyAttackDistance", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+21, offsetof(CEnemyFly, m_fFlyCloseDistance), "", 0, "m_fFlyCloseDistance", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+22, offsetof(CEnemyFly, m_fFlyAttackFireTime), "", 0, "m_fFlyAttackFireTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+23, offsetof(CEnemyFly, m_fFlyCloseFireTime), "", 0, "m_fFlyCloseFireTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+24, offsetof(CEnemyFly, m_fFlyStopDistance), "", 0, "m_fFlyStopDistance", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+25, offsetof(CEnemyFly, m_fFlyIgnoreRange), "", 0, "m_fFlyIgnoreRange", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000137<<8)+26, offsetof(CEnemyFly, m_fFlyLockOnEnemyTime), "", 0, "m_fFlyLockOnEnemyTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000137<<8)+100, offsetof(CEnemyFly, m_bFlyToMarker), "", 0, "m_bFlyToMarker", 0, 0),
};

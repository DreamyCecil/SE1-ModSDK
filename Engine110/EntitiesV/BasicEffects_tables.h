...
CEntityProperty CBasicEffect_properties[] = {
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENUM, &BasicEffectType_enum, (0x00000259<<8)+1, offsetof(CBasicEffect, m_betType), "", 0, "m_betType", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000259<<8)+2, offsetof(CBasicEffect, m_fWaitTime), "", 0, "m_fWaitTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000259<<8)+3, offsetof(CBasicEffect, m_fFadeTime), "", 0, "m_fFadeTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000259<<8)+4, offsetof(CBasicEffect, m_bFade), "", 0, "m_bFade", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000259<<8)+5, offsetof(CBasicEffect, m_fFadeStartTime), "", 0, "m_fFadeStartTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000259<<8)+9, offsetof(CBasicEffect, m_fFadeStartAlpha), "", 0, "m_fFadeStartAlpha", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000259<<8)+6, offsetof(CBasicEffect, m_vNormal), "", 0, "m_vNormal", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000259<<8)+7, offsetof(CBasicEffect, m_vStretch), "", 0, "m_vStretch", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000259<<8)+8, offsetof(CBasicEffect, m_vDirection), "", 0, "m_vDirection", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000259<<8)+10, offsetof(CBasicEffect, m_fDepthSortOffset), "", 0, "m_fDepthSortOffset", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000259<<8)+11, offsetof(CBasicEffect, m_fFadeInSpeed), "", 0, "m_fFadeInSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000259<<8)+12, offsetof(CBasicEffect, m_tmSpawn), "", 0, "m_tmSpawn", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000259<<8)+13, offsetof(CBasicEffect, m_tmWaitAfterDeath), "", 0, "m_tmWaitAfterDeath", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000259<<8)+20, offsetof(CBasicEffect, m_bLightSource), "", 0, "m_bLightSource", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANIMOBJECT, NULL, (0x00000259<<8)+21, offsetof(CBasicEffect, m_aoLightAnimation), "", 0, "m_aoLightAnimation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000259<<8)+22, offsetof(CBasicEffect, m_iLightAnimation), "", 0, "m_iLightAnimation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_COLOR, NULL, (0x00000259<<8)+23, offsetof(CBasicEffect, m_colMultiplyColor), "", 0, "m_colMultiplyColor", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000259<<8)+30, offsetof(CBasicEffect, m_soEffect), "", 0, "m_soEffect", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000259<<8)+31, offsetof(CBasicEffect, m_fSoundTime), "", 0, "m_fSoundTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENUM, &EffectParticlesType_enum, (0x00000259<<8)+40, offsetof(CBasicEffect, m_eptType), "", 0, "m_eptType", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000259<<8)+41, offsetof(CBasicEffect, m_tmWhenShot), "", 0, "m_tmWhenShot", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000259<<8)+42, offsetof(CBasicEffect, m_vGravity), "", 0, "m_vGravity", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000259<<8)+255, offsetof(CBasicEffect, m_penPrediction), "", 0, "m_penPrediction", 0, 0),
};

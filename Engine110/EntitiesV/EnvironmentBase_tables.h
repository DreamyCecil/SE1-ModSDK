...
CEntityProperty CEnvironmentBase_properties[] = {
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_STRING, NULL, (0x00000384<<8)+1, offsetof(CEnvironmentBase, m_strName), "Name", 'N', "m_strName", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_STRING, NULL, (0x00000384<<8)+2, offsetof(CEnvironmentBase, m_strDescription), "", 0, "m_strDescription", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_RANGE, NULL, (0x00000384<<8)+3, offsetof(CEnvironmentBase, m_fDistance), "Range", 'R', "m_fDistance", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000384<<8)+4, offsetof(CEnvironmentBase, m_fStretch), "Stretch", 'S', "m_fStretch", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000384<<8)+5, offsetof(CEnvironmentBase, m_penTarget), "Target", 'T', "m_penTarget", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000384<<8)+6, offsetof(CEnvironmentBase, m_penWatcher), "", 0, "m_penWatcher", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000384<<8)+7, offsetof(CEnvironmentBase, m_fWatcherFrequency), "Watcher frequency", 0, "m_fWatcherFrequency", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000384<<8)+8, offsetof(CEnvironmentBase, m_vDesiredPosition), "", 0, "m_vDesiredPosition", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000384<<8)+10, offsetof(CEnvironmentBase, m_fMoveSpeed), "Move speed", 'V', "m_fMoveSpeed", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000384<<8)+11, offsetof(CEnvironmentBase, m_fRotateSpeed), "Rotate speed", 'B', "m_fRotateSpeed", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000384<<8)+12, offsetof(CEnvironmentBase, m_fMoveFrequency), "Move frequency", 0, "m_fMoveFrequency", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000384<<8)+13, offsetof(CEnvironmentBase, m_bUseWatcher), "Use watcher", 0, "m_bUseWatcher", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000384<<8)+14, offsetof(CEnvironmentBase, m_bFlying), "Flying", 'F', "m_bFlying", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000384<<8)+16, offsetof(CEnvironmentBase, m_fWaitTime), "", 0, "m_fWaitTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FILENAME, NULL, (0x00000384<<8)+20, offsetof(CEnvironmentBase, m_fnMdl), "Model", 'M', "m_fnMdl", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FILENAME, NULL, (0x00000384<<8)+21, offsetof(CEnvironmentBase, m_fnTex), "Texture", 'X', "m_fnTex", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANIMATION, NULL, (0x00000384<<8)+22, offsetof(CEnvironmentBase, m_iAnim), "Animation", 0, "m_iAnim", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FILENAME, NULL, (0x00000384<<8)+25, offsetof(CEnvironmentBase, m_fnAtt1Mdl), "Attachment 1 Model", 0, "m_fnAtt1Mdl", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FILENAME, NULL, (0x00000384<<8)+26, offsetof(CEnvironmentBase, m_fnAtt1Tex), "Attachment 1 Texture", 0, "m_fnAtt1Tex", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000384<<8)+27, offsetof(CEnvironmentBase, m_iAtt1Position), "Attachment 1 position", 0, "m_iAtt1Position", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANIMATION, NULL, (0x00000384<<8)+28, offsetof(CEnvironmentBase, m_iAtt1Anim), "Attachment 1 animation", 0, "m_iAtt1Anim", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FILENAME, NULL, (0x00000384<<8)+30, offsetof(CEnvironmentBase, m_fnAtt2Mdl), "Attachment 2 Model", 0, "m_fnAtt2Mdl", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FILENAME, NULL, (0x00000384<<8)+31, offsetof(CEnvironmentBase, m_fnAtt2Tex), "Attachment 2 Texture", 0, "m_fnAtt2Tex", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000384<<8)+32, offsetof(CEnvironmentBase, m_iAtt2Position), "Attachment 2 position", 0, "m_iAtt2Position", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANIMATION, NULL, (0x00000384<<8)+33, offsetof(CEnvironmentBase, m_iAtt2Anim), "Attachment 2 animation", 0, "m_iAtt2Anim", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FILENAME, NULL, (0x00000384<<8)+35, offsetof(CEnvironmentBase, m_fnAtt3Mdl), "Attachment 3 Model", 0, "m_fnAtt3Mdl", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FILENAME, NULL, (0x00000384<<8)+36, offsetof(CEnvironmentBase, m_fnAtt3Tex), "Attachment 3 Texture", 0, "m_fnAtt3Tex", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000384<<8)+37, offsetof(CEnvironmentBase, m_iAtt3Position), "Attachment 3 position", 0, "m_iAtt3Position", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANIMATION, NULL, (0x00000384<<8)+38, offsetof(CEnvironmentBase, m_iAtt3Anim), "Attachment 3 animation", 0, "m_iAtt3Anim", 0x7F0000FFUL, 0),
};

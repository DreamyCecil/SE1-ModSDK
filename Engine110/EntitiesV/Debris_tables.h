...
CEntityProperty CDebris_properties[] = {
 ...
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000025a<<8)+10, offsetof(CDebris, m_fStretch), "", 0, "m_fStretch", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANGLE3D, NULL, (0x0000025a<<8)+11, offsetof(CDebris, m_aShadingDirection), "", 0, "m_aShadingDirection", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x0000025a<<8)+12, offsetof(CDebris, m_bCustomShading), "", 0, "m_bCustomShading", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_COLOR, NULL, (0x0000025a<<8)+13, offsetof(CDebris, m_colCustomAmbient), "", 0, "m_colCustomAmbient", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_COLOR, NULL, (0x0000025a<<8)+14, offsetof(CDebris, m_colCustomDiffuse), "", 0, "m_colCustomDiffuse", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x0000025a<<8)+15, offsetof(CDebris, m_bImmaterialASAP), "", 0, "m_bImmaterialASAP", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x0000025a<<8)+16, offsetof(CDebris, m_fDustStretch), "", 0, "m_fDustStretch", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x0000025a<<8)+17, offsetof(CDebris, m_bTouchedGround), "", 0, "m_bTouchedGround", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x0000025a<<8)+18, offsetof(CDebris, m_penFallFXPapa), "", 0, "m_penFallFXPapa", 0, 0),
};

...
CEntityProperty CTwister_properties[] = {
 ...
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001fb<<8)+2, offsetof(CTwister, m_fSize), "", 0, "m_fSize", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x000001fb<<8)+3, offsetof(CTwister, m_vSpeed), "", 0, "m_vSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x000001fb<<8)+4, offsetof(CTwister, m_sgnSpinDir), "", 0, "m_sgnSpinDir", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x000001fb<<8)+5, offsetof(CTwister, m_bGrow), "", 0, "m_bGrow", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001fb<<8)+6, offsetof(CTwister, m_tmLastMove), "", 0, "m_tmLastMove", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x000001fb<<8)+7, offsetof(CTwister, m_aSpeedRotation), "", 0, "m_aSpeedRotation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x000001fb<<8)+8, offsetof(CTwister, m_bMoving), "", 0, "m_bMoving", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x000001fb<<8)+9, offsetof(CTwister, m_bMovingAllowed), "", 0, "m_bMovingAllowed", 0, 0),
 ...
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x000001fb<<8)+23, offsetof(CTwister, m_fStartTime), "", 0, "m_fStartTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x000001fb<<8)+50, offsetof(CTwister, m_soSpin), "", 0, "m_soSpin", 0, 0),
};

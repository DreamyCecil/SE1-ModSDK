...
CEntityProperty CElemental_properties[] = {
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENUM, &ElementalType_enum, (0x00000142<<8)+1, offsetof(CElemental, m_EetType), "Type", 'Y', "m_EetType", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENUM, &ElementalCharacter_enum, (0x00000142<<8)+2, offsetof(CElemental, m_EecChar), "Character", 'C', "m_EecChar", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENUM, &ElementalState_enum, (0x00000142<<8)+3, offsetof(CElemental, m_EesStartState), "State", 'S', "m_EesStartState", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000142<<8)+4, offsetof(CElemental, m_bSpawnWhenHarmed), "Damage spawn", 'N', "m_bSpawnWhenHarmed", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000142<<8)+5, offsetof(CElemental, m_bSpawnOnBlowUp), "Blowup spawn", 'B', "m_bSpawnOnBlowUp", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENUM, &ElementalState_enum, (0x00000142<<8)+6, offsetof(CElemental, m_EesCurrentState), "", 0, "m_EesCurrentState", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000142<<8)+7, offsetof(CElemental, m_bSpawned), "", 0, "m_bSpawned", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000142<<8)+8, offsetof(CElemental, m_bMovable), "Movable", 'V', "m_bMovable", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_RANGE, NULL, (0x00000142<<8)+9, offsetof(CElemental, m_fLookRange), "Look range", 'O', "m_fLookRange", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000142<<8)+10, offsetof(CElemental, m_iFireCount), "Fire count", 0, "m_iFireCount", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000142<<8)+11, offsetof(CElemental, m_fWaitTime), "", 0, "m_fWaitTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000142<<8)+12, offsetof(CElemental, m_iCounter), "", 0, "m_iCounter", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000142<<8)+13, offsetof(CElemental, m_fDensity), "Density", 'D', "m_fDensity", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000142<<8)+20, offsetof(CElemental, m_penPosition1), "Position 1", 0, "m_penPosition1", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000142<<8)+21, offsetof(CElemental, m_penPosition2), "Position 2", 0, "m_penPosition2", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000142<<8)+22, offsetof(CElemental, m_penPosition3), "Position 3", 0, "m_penPosition3", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000142<<8)+23, offsetof(CElemental, m_penPosition4), "Position 4", 0, "m_penPosition4", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000142<<8)+24, offsetof(CElemental, m_penPosition5), "Position 5", 0, "m_penPosition5", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000142<<8)+25, offsetof(CElemental, m_penPosition6), "Position 6", 0, "m_penPosition6", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000142<<8)+30, offsetof(CElemental, m_soBackground), "", 0, "m_soBackground", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000142<<8)+31, offsetof(CElemental, m_ctSpawned), "", 0, "m_ctSpawned", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000142<<8)+32, offsetof(CElemental, m_fSpawnDamage), "", 0, "m_fSpawnDamage", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000142<<8)+33, offsetof(CElemental, m_bSpawnEnabled), "", 0, "m_bSpawnEnabled", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000142<<8)+34, offsetof(CElemental, m_soFireL), "", 0, "m_soFireL", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000142<<8)+35, offsetof(CElemental, m_soFireR), "", 0, "m_soFireR", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_INDEX, NULL, (0x00000142<<8)+36, offsetof(CElemental, m_bCountAsKill), "", 0, "m_bCountAsKill", 0, 0),
};
...
CEventHandlerEntry CElemental_handlers[] = {
 {0x01420000, -1, CEntity::pEventHandler(&CElemental::FallOnFloor),DEBUGSTRING("CElemental::FallOnFloor")},
 ...
 {0x01420003, -1, CEntity::pEventHandler(&CElemental::LavamanFire),DEBUGSTRING("CElemental::LavamanFire")},
 ...
 {0x01420017, -1, CEntity::pEventHandler(&CElemental::LavamanStones),DEBUGSTRING("CElemental::LavamanStones")},
 ...
 {0x0142001e, -1, CEntity::pEventHandler(&CElemental::LavamanHit),DEBUGSTRING("CElemental::LavamanHit")},
 ...
 {0x01420023, STATE_CEnemyBase_BeWounded, CEntity::pEventHandler(&CElemental::BeWounded),DEBUGSTRING("CElemental::BeWounded")},
 {0x01420024, -1, CEntity::pEventHandler(&CElemental::BoxToNormal),DEBUGSTRING("CElemental::BoxToNormal")},
 ...
 {0x01420027, -1, CEntity::pEventHandler(&CElemental::PlaneToNormal),DEBUGSTRING("CElemental::PlaneToNormal")},
 ...
 {0x0142002a, STATE_CEnemyBase_InitializeAttack, CEntity::pEventHandler(&CElemental::InitializeAttack),DEBUGSTRING("CElemental::InitializeAttack")},
 ...
 {0x01420032, STATE_CEnemyBase_Fire, CEntity::pEventHandler(&CElemental::Fire),DEBUGSTRING("CElemental::Fire")},
 {0x01420033, STATE_CEnemyBase_Hit, CEntity::pEventHandler(&CElemental::Hit),DEBUGSTRING("CElemental::Hit")},
 {0x01420034, STATE_CEnemyBase_Death, CEntity::pEventHandler(&CElemental::Death),DEBUGSTRING("CElemental::Death")},
 ...
 {0x0142003a, -1, CEntity::pEventHandler(&CElemental::BossAppear),DEBUGSTRING("CElemental::BossAppear")},
 ...
 {0x01420047, STATE_CEnemyBase_PreMainLoop, CEntity::pEventHandler(&CElemental::PreMainLoop),DEBUGSTRING("CElemental::PreMainLoop")},

...
CEntityProperty CPyramidSpaceShip_properties[] = {
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_STRING, NULL, (0x00000261<<8)+1, offsetof(CPyramidSpaceShip, m_strName), "Name", 'N', "m_strName", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+3, offsetof(CPyramidSpaceShip, m_fMovingSpeed), "", 0, "m_fMovingSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000261<<8)+5, offsetof(CPyramidSpaceShip, m_penBeamHit), "Beam hit target marker", 'T', "m_penBeamHit", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000261<<8)+6, offsetof(CPyramidSpaceShip, m_penLightBeam), "Beam model holder", 'B', "m_penLightBeam", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+7, offsetof(CPyramidSpaceShip, m_tmBeamTime), "", 0, "m_tmBeamTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000261<<8)+8, offsetof(CPyramidSpaceShip, m_penHitPlaceFlare), "Hit place flare", 'H', "m_penHitPlaceFlare", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+9, offsetof(CPyramidSpaceShip, m_tmHitFlareTime), "", 0, "m_tmHitFlareTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+10, offsetof(CPyramidSpaceShip, m_iRingCounter), "", 0, "m_iRingCounter", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+11, offsetof(CPyramidSpaceShip, m_fRatio), "", 0, "m_fRatio", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_STRING, NULL, (0x00000261<<8)+12, offsetof(CPyramidSpaceShip, m_strDescription), "", 0, "m_strDescription", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENUM, &PSSState_enum, (0x00000261<<8)+13, offsetof(CPyramidSpaceShip, m_epssState), "", 0, "m_epssState", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+14, offsetof(CPyramidSpaceShip, m_fStretch), "Stretch", 'S', "m_fStretch", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000261<<8)+20, offsetof(CPyramidSpaceShip, m_bStopMoving), "", 0, "m_bStopMoving", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000261<<8)+21, offsetof(CPyramidSpaceShip, m_penTarget), "Target", 'T', "m_penTarget", C_lBLUE  | 0xFF, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000261<<8)+29, offsetof(CPyramidSpaceShip, m_penFlyAwayTarget), "Fly away path marker", 0, "m_penFlyAwayTarget", C_lBLUE  | 0xFF, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000261<<8)+22, offsetof(CPyramidSpaceShip, m_penLast), "", 0, "m_penLast", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000261<<8)+23, offsetof(CPyramidSpaceShip, m_bMoving), "", 0, "m_bMoving", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+24, offsetof(CPyramidSpaceShip, m_fRot), "", 0, "m_fRot", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+25, offsetof(CPyramidSpaceShip, m_fLastRotSpeed), "", 0, "m_fLastRotSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+26, offsetof(CPyramidSpaceShip, m_fRotSpeed), "", 0, "m_fRotSpeed", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000261<<8)+27, offsetof(CPyramidSpaceShip, m_bApplyDamageToHitted), "", 0, "m_bApplyDamageToHitted", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+28, offsetof(CPyramidSpaceShip, m_tmTemp), "", 0, "m_tmTemp", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+30, offsetof(CPyramidSpaceShip, m_tmAtMarker), "", 0, "m_tmAtMarker", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+31, offsetof(CPyramidSpaceShip, m_tmDelta), "", 0, "m_tmDelta", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000261<<8)+32, offsetof(CPyramidSpaceShip, m_vPNp0), "", 0, "m_vPNp0", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000261<<8)+33, offsetof(CPyramidSpaceShip, m_vPNp1), "", 0, "m_vPNp1", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000261<<8)+34, offsetof(CPyramidSpaceShip, m_vTNp0), "", 0, "m_vTNp0", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000261<<8)+35, offsetof(CPyramidSpaceShip, m_vTNp1), "", 0, "m_vTNp1", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOATQUAT3D, NULL, (0x00000261<<8)+36, offsetof(CPyramidSpaceShip, m_qPNp0), "", 0, "m_qPNp0", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOATQUAT3D, NULL, (0x00000261<<8)+37, offsetof(CPyramidSpaceShip, m_qPNp1), "", 0, "m_qPNp1", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOATQUAT3D, NULL, (0x00000261<<8)+38, offsetof(CPyramidSpaceShip, m_qANp0), "", 0, "m_qANp0", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOATQUAT3D, NULL, (0x00000261<<8)+39, offsetof(CPyramidSpaceShip, m_qANp1), "", 0, "m_qANp1", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+40, offsetof(CPyramidSpaceShip, m_fRotSpeedp0), "", 0, "m_fRotSpeedp0", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+41, offsetof(CPyramidSpaceShip, m_fRotSpeedp1), "", 0, "m_fRotSpeedp1", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+42, offsetof(CPyramidSpaceShip, m_fTRotSpeedp0), "", 0, "m_fTRotSpeedp0", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+43, offsetof(CPyramidSpaceShip, m_fTRotSpeedp1), "", 0, "m_fTRotSpeedp1", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000261<<8)+50, offsetof(CPyramidSpaceShip, m_soPlates), "", 0, "m_soPlates", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000261<<8)+51, offsetof(CPyramidSpaceShip, m_soBeamMachine), "", 0, "m_soBeamMachine", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000261<<8)+52, offsetof(CPyramidSpaceShip, m_soBeam), "", 0, "m_soBeam", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000261<<8)+53, offsetof(CPyramidSpaceShip, m_soFlaresFX), "", 0, "m_soFlaresFX", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000261<<8)+54, offsetof(CPyramidSpaceShip, m_bFireingDeactivatedBeam), "", 0, "m_bFireingDeactivatedBeam", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000261<<8)+55, offsetof(CPyramidSpaceShip, m_bImmediateAnimations), "", 0, "m_bImmediateAnimations", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000261<<8)+56, offsetof(CPyramidSpaceShip, m_fWaitAfterKillingBeam), "Wait after auto killing beam", 'W', "m_fWaitAfterKillingBeam", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000261<<8)+60, offsetof(CPyramidSpaceShip, m_bInvisible), "Invisible", 'I', "m_bInvisible", 0x7F0000FFUL, 0),
};

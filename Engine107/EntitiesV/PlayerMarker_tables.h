...
CEntityProperty CPlayerMarker_properties[] = {
 ...
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000194<<8)+12, offsetof(CPlayerMarker, m_bNoRespawnInPlace), "No Respawn In Place", 'R', "m_bNoRespawnInPlace", 0x7F0000FFUL, 0),
};

...
CEntityProperty CCannonRotating_properties[] = {
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+1, offsetof(CCannonRotating, m_fHealth), "Cannon Health", 0, "m_fHealth", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_RANGE, NULL, (0x00000159<<8)+2, offsetof(CCannonRotating, m_fFiringRangeClose), "Cannon Firing Close Range", 0, "m_fFiringRangeClose", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_RANGE, NULL, (0x00000159<<8)+3, offsetof(CCannonRotating, m_fFiringRangeFar), "Cannon Firing Far Range", 0, "m_fFiringRangeFar", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+4, offsetof(CCannonRotating, m_fWaitAfterFire), "Cannon Wait After Fire", 0, "m_fWaitAfterFire", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+5, offsetof(CCannonRotating, m_fSize), "", 0, "m_fSize", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+6, offsetof(CCannonRotating, m_fMaxPitch), "Cannon Max Pitch", 0, "m_fMaxPitch", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+7, offsetof(CCannonRotating, m_fViewAngle), "Cannon View Angle", 0, "m_fViewAngle", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+8, offsetof(CCannonRotating, m_fScanAngle), "Cannon Scanning Angle", 0, "m_fScanAngle", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+9, offsetof(CCannonRotating, m_fRotationSpeed), "Cannon Rotation Speed", 0, "m_fRotationSpeed", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000159<<8)+10, offsetof(CCannonRotating, m_bActive), "Cannon Active", 0, "m_bActive", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000159<<8)+20, offsetof(CCannonRotating, m_fRotSpeedMuzzle), "", 0, "m_fRotSpeedMuzzle", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000159<<8)+21, offsetof(CCannonRotating, m_fRotSpeedRotator), "", 0, "m_fRotSpeedRotator", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+25, offsetof(CCannonRotating, m_fDistanceToPlayer), "", 0, "m_fDistanceToPlayer", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+26, offsetof(CCannonRotating, m_fDesiredMuzzlePitch), "", 0, "m_fDesiredMuzzlePitch", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+27, offsetof(CCannonRotating, m_iMuzzleDir), "", 0, "m_iMuzzleDir", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000159<<8)+28, offsetof(CCannonRotating, m_vFiringPos), "", 0, "m_vFiringPos", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000159<<8)+29, offsetof(CCannonRotating, m_vTarget), "", 0, "m_vTarget", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+30, offsetof(CCannonRotating, m_tmLastFireTime), "", 0, "m_tmLastFireTime", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000159<<8)+40, offsetof(CCannonRotating, m_aBeginMuzzleRotation), "", 0, "m_aBeginMuzzleRotation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000159<<8)+41, offsetof(CCannonRotating, m_aEndMuzzleRotation), "", 0, "m_aEndMuzzleRotation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000159<<8)+42, offsetof(CCannonRotating, m_aBeginRotatorRotation), "", 0, "m_aBeginRotatorRotation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000159<<8)+43, offsetof(CCannonRotating, m_aEndRotatorRotation), "", 0, "m_aEndRotatorRotation", 0, 0),
};

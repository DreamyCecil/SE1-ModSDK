...
CModelObject m_moRender;
  ...
  virtual void LeaveStain(BOOL bGrow);
   ...
   void RenderHUD(CPerspectiveProjection3D & prProjection,CDrawPort * pdp,FLOAT3D vViewerLightDirection,COLOR colViewerLight,COLOR colViewerAmbient,BOOL bRenderWeapon,INDEX iEye);
...
static const char *CPlayer_propnames[] = {
  ...
  "m_tmSeriousSpeed",
  "m_tmInvisibilityMax",
  "m_tmInvulnerabilityMax",
  "m_tmSeriousDamageMax",
  "m_tmSeriousSpeedMax",
  "m_tmChainShakeEnd",
  "m_fChainShakeStrength",
  "m_fChainShakeFreqMod",
  "m_fChainsawShakeDX",
  "m_fChainsawShakeDY",
  "m_iSeriousBombCount",
  "m_iLastSeriousBombCount",
  "m_tmSeriousBombFired",
  "m_penPrediction",
};

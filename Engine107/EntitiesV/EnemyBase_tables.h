...
CEntityProperty CEnemyBase_properties[] = {
 ...
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000136<<8)+160, offsetof(CEnemyBase, m_penTacticsHolder), "Tactics Holder", 0, "m_penTacticsHolder", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000136<<8)+161, offsetof(CEnemyBase, m_bTacticActive), "", 0, "m_bTacticActive", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000136<<8)+162, offsetof(CEnemyBase, m_tmTacticsActivation), "", 0, "m_tmTacticsActivation", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT3D, NULL, (0x00000136<<8)+163, offsetof(CEnemyBase, m_vTacticsStartPosition), "", 0, "m_vTacticsStartPosition", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000136<<8)+165, offsetof(CEnemyBase, m_fTacticVar1), "", 0, "m_fTacticVar1", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000136<<8)+166, offsetof(CEnemyBase, m_fTacticVar2), "", 0, "m_fTacticVar2", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000136<<8)+167, offsetof(CEnemyBase, m_fTacticVar3), "", 0, "m_fTacticVar3", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000136<<8)+168, offsetof(CEnemyBase, m_fTacticVar4), "", 0, "m_fTacticVar4", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000136<<8)+169, offsetof(CEnemyBase, m_fTacticVar5), "", 0, "m_fTacticVar5", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000136<<8)+170, offsetof(CEnemyBase, m_bTacticsStartOnSense), "Tactics start on sense", 0, "m_bTacticsStartOnSense", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_COLOR, NULL, (0x00000136<<8)+180, offsetof(CEnemyBase, m_colBurning), "", 0, "m_colBurning", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000136<<8)+181, offsetof(CEnemyBase, m_bResizeAttachments), "Stretch attachments", 0, "m_bResizeAttachments", 0x7F0000FFUL, 0),

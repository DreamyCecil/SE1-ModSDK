...
CEntityProperty CEnemyMarker_properties[] = {
 ...
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x0000012e<<8)+18, offsetof(CEnemyMarker, m_bStartTactics), "Start Tactics", 0, "m_bStartTactics", 0x7F0000FFUL, 0),
};

...
CEntityProperty CShooter_properties[] = {
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+2, offsetof(CShooter, m_fShootingPeriod), "Shooting Period", 0, "m_fShootingPeriod", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENUM, &FireType_enum, (0x00000159<<8)+5, offsetof(CShooter, m_sftType), "Type", 'Y', "m_sftType", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+7, offsetof(CShooter, m_fHealth), "Health", 0, "m_fHealth", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+8, offsetof(CShooter, m_fCannonBallSize), "Cannon/fire ball size", 0, "m_fCannonBallSize", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+9, offsetof(CShooter, m_fCannonBallPower), "Cannon/fire ball power", 0, "m_fCannonBallPower", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANIMATION, NULL, (0x00000159<<8)+10, offsetof(CShooter, m_iModelPreFireAnimation), "Model pre-fire animation", 0, "m_iModelPreFireAnimation", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANIMATION, NULL, (0x00000159<<8)+11, offsetof(CShooter, m_iTexturePreFireAnimation), "Texture pre-fire animation", 0, "m_iTexturePreFireAnimation", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANIMATION, NULL, (0x00000159<<8)+12, offsetof(CShooter, m_iModelPostFireAnimation), "Model post-fire animation", 0, "m_iModelPostFireAnimation", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ANIMATION, NULL, (0x00000159<<8)+13, offsetof(CShooter, m_iTexturePostFireAnimation), "Texture post-fire animation", 0, "m_iTexturePostFireAnimation", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+14, offsetof(CShooter, m_fFlameBurstDuration), "Flame burst duration", 0, "m_fFlameBurstDuration", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+15, offsetof(CShooter, m_fRndBeginWait), "Random begin wait time", 0, "m_fRndBeginWait", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000159<<8)+20, offsetof(CShooter, m_penSoundLaunch), "Sound launch", 0, "m_penSoundLaunch", 0x7F0000FFUL, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_SOUNDOBJECT, NULL, (0x00000159<<8)+21, offsetof(CShooter, m_soLaunch), "", 0, "m_soLaunch", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_ENTITYPTR, NULL, (0x00000159<<8)+30, offsetof(CShooter, m_penFlame), "", 0, "m_penFlame", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000159<<8)+50, offsetof(CShooter, m_bFiring), "", 0, "m_bFiring", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_BOOL, NULL, (0x00000159<<8)+51, offsetof(CShooter, m_bIndestructable), "", 0, "m_bIndestructable", 0, 0),
 ENGINE_SPECIFIC_PROP_DEF(CEntityProperty::EPT_FLOAT, NULL, (0x00000159<<8)+60, offsetof(CShooter, m_tmFlameStart), "", 0, "m_tmFlameStart", 0, 0),
};
